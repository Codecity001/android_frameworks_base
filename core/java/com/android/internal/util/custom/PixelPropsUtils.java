...
public class PixelPropsUtils {
    ...
    private static final String[] packagesToChangePixelXL = { "com.google.android.apps.photos" };

    private static final String[] packagesToChangePixel5 = { "com.google.android.googlequicksearchbox" };
